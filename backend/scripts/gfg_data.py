...
def getGFGDetails(username='ajinkyadeshpande0000'):
    ...
    try:
        if browser.current_url != URL:
            raise Exception("Something went wrong! Check the username you have entered")

        # Total Solved Questions
        total_questions_element = browser.find_element_by_xpath('//*[@id="detail1"]/div[1]/div[6]/div[2]/a')
        total_questions_string = str(total_questions_element.get_attribute('innerHTML'))
        total_questions = ''
        ...
        coding_score_element = browser.find_element_by_xpath('//*[@id="detail1"]/div[1]/div[6]/div[1]')
        coding_score_string = str(coding_score_element.get_attribute('innerHTML'))
        coding_score = ''
        ...
        pie_chart_script_tag = browser.find_element_by_xpath('//*[@id="detail1"]/div[2]/script')
        pie_chart_script_tag_string = str(pie_chart_script_tag.get_attribute('innerHTML'))
        ...
        for i in range(0, len(pie_chart_array)):
            pie_chart_questions_data[pie_chart_array_name[i]] = int(pie_chart_array[i])
        ...
        return {
            ...
            'types_of_questions_solved': pie_chart_questions_data
        }
